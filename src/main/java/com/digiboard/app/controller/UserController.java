...
public class UserController implements Serializable{
    ...
    public void handleFileUpload(FileUploadEvent event){
        ...
        this.user.setPhoto("/img/" + event.getFile().getFileName());
    }
    
    //Método que salva a imagem selecionada
    public void saveImage(){
        if(uploadedFile != null){
            File newArchive = new File("C:/Users/Felipe/Documents/NetBeansProjects/app/src/main/webapp/resources/img/uploads/" + this.uploadedFile.getFileName());
            try {
